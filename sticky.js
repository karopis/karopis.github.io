...
(function( $ )
	...
	$.fn.sticky = function(note, options, callback) 
		...
		var settings =
			...
			'autoclose'		:	7500  // integer or false
			};
	...
	$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="r-a-user-icon" src="player-icon.png"/><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_amount() +'</div></div>');
	var call_recent_activity_tab = function() {
		$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="r-a-user-icon" src="player-icon.png"/><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_amount() +'</div></div>');
	}
	$random_time = Math.floor((Math.random() * 5000) + 3000);
	setInterval(call_recent_activity_tab, $random_time);
